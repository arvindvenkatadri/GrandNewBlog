...
ANOVA says the reduction in error Sum of Squares is merely 9.429! The `p.value` is $0.02028$ so there **is** a significant difference in mean academic scores across the three degree awards. The Significance score is a **single star** so this is also not too great a difference.
